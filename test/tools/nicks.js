...
const params = ethers.utils.defaultAbiCoder.encode(['address'], [`0x${Buffer.from(ethers.utils.randomBytes(20)).toString('hex')}`])
...
describe('Nicks Method', () => {
  ...
  describe('decorateTx', () => {
    ...
    it('attaches correct information', async () => {
      const reciept = await (await ethers.provider.sendTransaction(decorated.raw)).wait()
