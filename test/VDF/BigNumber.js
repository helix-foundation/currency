...
describe('BigNumber [@group=3]', () => {
  ...
  describe('Input', () => {
    it('Rejects malformed aligned bigint words', async () => {
    ...
    it('Rejects malformed unaligned bigint words', async () => {
      const bigone = `0x0001${'00'.repeat(63)}`
      await expect(bignum.fromBytes(bigone)).to.be.revertedWith(
        'High-word must be set when input is bytes32-aligned'
      )
    })
    ...
    it('Matches padded byte 1', async () => {
      ...
      expect(await bignum.asBytes(one, 32)).to.equal(one)
    })

    it('Reduces padded byte 1', async () => {
      const one = `0x${'00'.repeat(31)}01`
    ...
    it('Rejects invalid rightShift input', async () => {
      await expect(
        bignum.rightShift(`0x${'ff'.repeat(1092)}`)
  ...
  describe('byte lengths', () => {
    it('Matches 1', async () => {
      expect(await bignum.byteLength('0x')).to.equal(0)
    })

    it('Matches 1', async () => {
      expect(
        await bignum.byteLength(
          ''
        )
      ).to.equal(256)
    })
    ...
    it('Matches 1', async () => {
      expect(await bignum.minimalByteLength('0x')).to.equal(0)
    })

    it('Matches 1', async () => {
      expect(
        await bignum.minimalByteLength(
          ''
        )
      ).to.equal(255)
    })
