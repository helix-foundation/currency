...
const defn = new BN('', 16);
...
function prove(x, tinput, n = defn) {
  ...
  for (let i = 0; i < t - 1; i += 1) {
    ...
    const res = ethers.utils.solidityKeccak256(
      ...
      [
        ethers.utils.solidityKeccak256(['uint256', 'bytes'], [x.toString(), bnHex(y, bytelen)]),
...
if (typeof require !== 'undefined' && require.main === module) {
  ...
  process.stdout.write(JSON.stringify(prove(new BN(options.x), new BN(options.t))));
